...
final class VelocityExpansion extends PlaceholderExpansion {
 private final CredibleCrowdPaper plugin; VelocityExpansion(CredibleCrowdPaper plugin){this.plugin=plugin;}
 @Override public @NotNull String getIdentifier(){return "velocity";}
